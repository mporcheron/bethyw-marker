...
const std::string &Measure::getCodename() const {
  throw std::logic_error("Measure::getCodename() has not been implemented!");
}
...
const std::string &Measure::getLabel() const {
  throw std::logic_error("Measure::getLabel() has not been implemented!");
}
...
void Measure::setLabel(const std::string &label) {
  throw std::logic_error("Measure::setLabel() has not been implemented!");
}
...
Measure_t &Measure::getValue(const int &key) {
  throw std::logic_error("Measure::getValue() has not been implemented!");
}
...
void Measure::setValue(const int &key, const Measure_t &value) {
  throw std::logic_error("Measure::setValue() has not been implemented!");
}
